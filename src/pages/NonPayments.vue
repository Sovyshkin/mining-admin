  ...
  <div class="wrapper">
    ...
    <div class="cards">
      <div class="card" v-for="card in cards" :key="card.id">
        <span class="card-item card-item-open">{{ card.id }}</span>
        <span class="card-item card-item-open">{{ card.fio }}</span>
        <span class="card-item card-item-open">{{ card.id_payment }}</span>
        <span class="card-item">{{ card.delay }} дней</span>
        <span class="card-item">{{ card.phone }}</span>
        <span class="card-item">{{ card.date }}</span>
